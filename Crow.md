...
![](Crow_files/figure-markdown_strict/unnamed-chunk-5-1.png)
...
![](Crow_files/figure-markdown_strict/unnamed-chunk-8-1.png)

This plot allows us to see the crows in relation to Switzerland. We can
see that there is quite a lot of observations in Ticino. A part from
...
that happen between lions and tigers, that means they are different
species. So, I will take these as the same species (Turner, 2002)
...
![](Crow_files/figure-markdown_strict/unnamed-chunk-10-1.png)
...
![](Crow_files/figure-markdown_strict/unnamed-chunk-13-1.png)
...
![](Crow_files/figure-markdown_strict/unnamed-chunk-14-1.png) This graph
...
![](Crow_files/figure-markdown_strict/unnamed-chunk-15-1.png)
...
![](Crow_files/figure-markdown_strict/unnamed-chunk-19-1.png)
...
![](Crow_files/figure-markdown_strict/unnamed-chunk-20-1.png)
...
![](Crow_files/figure-markdown_strict/unnamed-chunk-21-1.png)
...
![](Crow_files/figure-markdown_strict/unnamed-chunk-22-1.png)
...
![](Crow_files/figure-markdown_strict/unnamed-chunk-23-1.png)
...
land cover is related to season/month, hour, or elevation.
    ...
    ## t = -0.52831, df = 111, p-value = 0.5983
    ...
    ## Month       1   1.08  1.0771  0.2791 0.5983
    ## Residuals 111 428.36  3.8591
...
choice of land?
    ...
    ## t = 1.0358, df = 111, p-value = 0.3025
    ## alternative hypothesis: true correlation is not equal to 0
    ## 95 percent confidence interval:
    ##  -0.08848433  0.27755784
    ## sample estimates:
    ##        cor 
    ## 0.09784483
    ...
    ## Response: LC
    ##            Df Sum Sq Mean Sq F value Pr(>F)
    ## Hour        1   4.11  4.1112  1.0729 0.3025
    ## Residuals 111 425.32  3.8317
...
choice, with a p-value of 0.16.
    ...
    ## t = 0.029072, df = 111, p-value = 0.9769
    ## alternative hypothesis: true correlation is not equal to 0
    ## 95 percent confidence interval:
    ##  -0.1820632  0.1873937
    ## sample estimates:
    ...
    ## Response: LC
    ##            Df Sum Sq Mean Sq F value Pr(>F)
    ## Elevation   1   0.00  0.0033   8e-04 0.9769
    ## Residuals 111 429.43  3.8687
...
-   Crows tend to be more active during early morning from 6:30-8:30
    a.m.
-   They tend to prefer lower elevations ranging from 200-300m, and
    rarely are they observed at higher altitudes than 400m.
...
permanent snow and ice, barren or in water observations simply because
many people do not go there, and if they do go and see a crow, they
might not register it on either GBIF or iNaturalist. In addition, this
data set relies on amateur observations. This means that people might
register their observation as a crow but it might have been a raven, or
a rook, the best way to exclude erroneous data was to filter research
grade observations, however due to low amount of observations I decided
to keep them all and not filter for that.
...
higher occurrence and density in vegetated areas. This confirms my
hypothesis. Furthermore, there was no correlation or statistical
significance for the season, time of day, or elevatio as a reason for
...
Cover Type Yearly L3 Global 500m SIN Grid V006 \[dataset\]. NASA EOSDIS
